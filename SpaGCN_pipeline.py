...
for dataset in dataset_list:
    ...
    results.to_csv(
        f"/data/bqliu_data/jxliu_data/projects/SpaGFT/SpaGFT_SpaGCN/results/DLPFC/SpaGCN_{dataset}_results.csv")
perf_df.to_csv(
    "/data/bqliu_data/jxliu_data/projects/SpaGFT/SpaGFT_SpaGCN/results//SpaGCN_independent_results.csv")
